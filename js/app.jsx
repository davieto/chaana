...
const SEED_RATINGS = [
  ...
  { id:uid(), title:'Mortal Kombat',                type:'filme', rating:3, section:'watched', poster:'assets/posters/mortal-kombat.jpg' },
  { id:uid(), title:'Mortal Kombat 2',              type:'filme', rating:4, section:'watched', poster:'assets/posters/mortal-kombat-2.jpg' },
  { id:uid(), title:'House of the Dragon',          type:'serie', rating:0, section:'waiting', poster:'assets/posters/house-of-the-dragon.jpg' },
  { id:uid(), title:'Bridgerton',                   type:'serie', rating:0, section:'waiting', poster:'assets/posters/bridgerton.jpg' },
  { id:uid(), title:'Sissi',                        type:'serie', rating:0, section:'waiting', poster:'assets/posters/sissi.jpg' },
  { id:uid(), title:'Jujutsu Kaisen',               type:'serie', rating:0, section:'waiting', poster:'assets/posters/jujutsu-kaisen.jpg' },
  { id:uid(), title:'Korra (Dublado)',               type:'serie', rating:0, section:'waiting', poster:'assets/posters/korra.jpg' },
  { id:uid(), title:'A Noiva Cadáver',              type:'filme', rating:0, section:'waiting', poster:'assets/posters/noiva-cadaver.jpg' },
  { id:uid(), title:'Coco',                         type:'filme', rating:0, section:'waiting', poster:'assets/posters/coco.jpg' },
  { id:uid(), title:'Koe no Katachi',               type:'filme', rating:0, section:'waiting', poster:'assets/posters/koe-no-katachi.jpg' },
  { id:uid(), title:'Your Name',                    type:'filme', rating:0, section:'waiting', poster:'assets/posters/your-name.jpg' },
  { id:uid(), title:'Tenki no Ko',                  type:'filme', rating:0, section:'waiting', poster:'assets/posters/tenki-no-ko.jpg' },
  { id:uid(), title:'5 Centímetros por Segundo',    type:'filme', rating:0, section:'waiting', poster:'assets/posters/5-centimetros.jpg' },
  { id:uid(), title:'The Garden of Words',          type:'filme', rating:0, section:'waiting', poster:'assets/posters/garden-of-words.jpg' },
  { id:uid(), title:'Children Who Chase Lost Voices', type:'filme', rating:0, section:'waiting', poster:'assets/posters/children-who-chase-lost-voices.jpg' },
];
